# -*- coding: utf-8 -*-
"""
run script and evaluate topic distributions for 1:
1: vary chunk size
2: vary pruning (is stopword filtering?)
3: remove text normalization
4: change intial seed
5: vary k number of topics
6: get document representation (method get_document_topics(corpus[docidx]))
@author: kln
"""
